            ...
            <div class="row routeplanner view1" ng-show="planning">
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" ng-model="destination" placeholder="{{Lang::get('client.typeToStation')}}" typeahead="station as station.name for station in stations['@graph'] | filter:{name:$viewValue} | limitTo:5" typeahead-template-url="customTemplate.html" typeahead-on-select='focusOnConfirm()' class="form-control input-lg" tabindex="2">
